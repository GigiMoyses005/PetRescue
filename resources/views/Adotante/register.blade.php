...
<div class="login-container">
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('adotante.register.post') }}">
            @csrf
            ...
            <div class="login-field">
                ...
                <input type="text" name="cpf" class="login-input" required>
            </div>

            {{-- TELEFONE --}}
            <div class="login-field">
                <label class="login-label">Telefone</label>
                <input type="text" name="telefone" class="login-input" required>
            </div>
            ...
            <div class="login-field">
                ...
                <input type="password" name="password_confirmation" class="login-input" required>
            </div>

            <button type="submit" class="login-button">Cadastrar</button>

            <a href="{{ route('adotante.login') }}"
